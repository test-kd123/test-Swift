...
class PDFToCSV: NSObject {
    ...
    class func entrance() {
        // Create a task
        self.client.createTask(url: CPDFConversion.PDF_TO_CSV) { model in
...
//            let path = Bundle.main.path(forResource: "test", ofType: "pdf")
            ...
            self.client.uploadFile(filepath: path!, password: "1234", params: [CPDFFileUploadParameterKey.isCsvMerge.string() : "1"], taskId: _taskId) { uploadFileModel in
                group.leave()
            }
